...
class="glyphicon glyphicon-edit"></span>&nbsp;免费发布</a></li>

<?php if($_userid) { ?>
<li class="before-login-link"><a href="member.php">欢迎你：<?php echo $_username;?></a></li>
<?php if($_status<=0) { ?>
<li class="before-login-link" id="login_link"><a
href="member.php?act=send_check_email">[验证邮件]</a></li> <?php } ?>
<li class="before-login-link"><a
href="member.php?act=logout&mid=<?php echo $_userid;?>">[退出]</a></li>
<?php } else { ?>
<li class="before-login-link" id="login_link">
<!--<a href="member.php?act=login&refer=<?php echo $PHP_URL;?>">登录</a> -->
<a href="javascript:void(0)">登录</a>
</li>
<li class="before-login-link" id="register_link">
<!-- <a href="member.php?act=register">注册</a> -->
