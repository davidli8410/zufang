...
define('PHPMPS_ROOT', preg_replace('/include(.*)/i', '', str_replace('\\', '/', __FILE__)));
require PHPMPS_ROOT .  'include/common.php';
...
$root_path = preg_replace('/include(.*)/i', '', PHP_SELF);

$enable = true;
if (empty($_SESSION['adminid']) || empty($_SESSION['adminpass']))
{
    $enable = false;
...
$Config['UserFilesPath'] = $root_path . 'data/upload/';

// Fill the following value it you prefer to specify the absolute path for the
// user files directory. Useful if you are using a virtual directory, symbolic
// link or alias. Examples: 'C:\\MySite\\userfiles\\' or '/root/mysite/userfiles/'.
// Attention: The above 'UserFilesPath' must point to the same directory.
$Config['UserFilesAbsolutePath'] = PHPMPS_ROOT . 'data/upload/' ;
