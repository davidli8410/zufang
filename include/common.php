...
define('DEBUG_MODE', 0);
define('PHPMPS_PATH', $CFG['weburl'].'/');//利峽
define('CSS_PATH', $CFG['weburl'].'/templates/'.$CFG['tplname'].'/style/');//css利峽
define('IMG_PATH', $CFG['weburl'].'/templates/'.$CFG['tplname'].'/images/');//夕頭利峽
